// npm i puppeteer   ---- to install puppeteer with chromium
...
(async function () {
  ...
  try {
    ...
    await tab.click("button.sqdOP.yWX7d.y3zKF"), tab.waitForNavigation({
        waitUntil : "networkidle0"
    })
  await tab.waitFor(2000);
    await tab.type("input[placeholder='Search']", pUrl, { delay: 120 });
    await tab.waitFor(2000);
...
// node igauto.js "igcredential.json" "the_hindu"